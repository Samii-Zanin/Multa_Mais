...
$policial = new Policial($cpf,  $email, $senhaHash, $nome,$cargo,$local_servico,$departamento);
$policial->save();
...
<head>
    ...
    <title>SRMV — Registro Concluído</title>
    ...
    <style>
        :root {
            ...
            --accent: #1a6fff; --success: #27ae60; --text: #e2e6ef; --muted: #5a6478;
        }
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon {
            width: 56px; height: 56px; border: 2px solid var(--success);
        ...
        .tag {
            ...
            font-size: 9px; letter-spacing: 3px; color: var(--success);
            text-transform: uppercase; margin-bottom: 10px;
        }
        h1 {
            font-family: 'Bebas Neue', sans-serif;
            font-size: 32px; letter-spacing: 2px; margin-bottom: 12px;
        }
        p {
        ...
        .progress-bar {
            height: 2px; background: var(--border); width: 100%; margin-bottom: 16px;
        }
        .progress-fill {
...
<body>
    <div class='card'>
        ...
        <h1>Agente Cadastrado</h1>
        <p>Seu acesso foi criado com sucesso.<br>Redirecionando para a tela de login...</p>

        <div class='progress-bar'>
            <div class='progress-fill'></div>
        </div>
        <div class='redirect-msg'>Redirecionando em 3 segundos</div>
        <a href='login.php'>Ir agora →</a>
    </div>
</body>
</html>
";