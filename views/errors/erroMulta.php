<?php
$erro_multa = isset($_GET['erro']) ? htmlspecialchars($_GET['erro']) : 'Erro desconhecido.';
echo "
<!DOCTYPE html>
<html lang='pt-BR'>
<head>
    <meta charset='UTF-8'>
    <meta http-equiv='refresh' content='10;url=../../views/dashboard.php?modal=multa'>
    <title>SRMV — Erro ao Cadastrar Multa</title>
...
<body>
    <div class='card'>
        ...
        <p>Não foi possível registrar a multa.<br>Verifique os dados e tente novamente.</p>
        <p class='erro-detalhe'>Erro: " . $erro_multa . "</p>
        <div class='progress-bar'><div class='progress-fill'></div></div>
        <div class='redirect-msg'>Retornando em 10 segundos</div>
        <a href='../dashboard.php?modal=multa'>← Voltar agora</a>
    </div>
</body>
</html>"
;
